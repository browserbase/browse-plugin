...
import { computeExpectedGemini, normalizeNewlines, GEMINI_PATH } from "./gemini-sync.mjs";
...
const actualRaw = await fs.readFile(geminiPath, "utf8").catch(() => null);
const actual = actualRaw === null ? null : normalizeNewlines(actualRaw);
